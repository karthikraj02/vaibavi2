      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="glass-panel relative w-full max-w-md p-8 rounded-3xl border border-white/10 shadow-[0_0_50px_rgba(0,240,255,0.15)] overflow-hidden"
          >
            ...
            <p className="text-gray-400 text-center mb-8 font-light text-sm">Enter your credentials to securely connect</p>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit" 
                className="neon-button w-full py-3.5 rounded-xl font-bold bg-gradient-to-r from-neonCyan to-blue-600 mt-4 text-lg shadow-[0_0_15px_rgba(0,240,255,0.4)] cursor-pointer"
              >
                Authenticate
              </button>
            </form>
            ...
            <div className="space-y-3">
              ...
              <GoogleSignInButton
                onSuccess={() => { if (onClose) onClose(); navigate('/'); }}
            ...
            <div className="mt-8 text-center pt-6 border-t border-white/10">
              <Link to="/register" onClick={() => { if(onClose) onClose(); }} className="text-sm font-medium text-gray-400 hover:text-white transition-colors">
                New user? <span className="text-neonCyan">Initialize Access</span>
              </Link>
            </div>
          </motion.div>
        </div>
